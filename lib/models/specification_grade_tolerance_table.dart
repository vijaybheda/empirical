...
class SpecificationGradeToleranceTable {
  ...
  SpecificationGradeToleranceTable({
  ...
  SpecificationGradeToleranceTable copyWith({
    String? specificationNumber,
    String? specificationVersion,
    double? gradeTolerancePercentage,
    double? specTolerancePercentage,
    ...
    return SpecificationGradeToleranceTable(
...
// fromJson method
  factory SpecificationGradeToleranceTable.fromJson(Map<String, dynamic> json) {
    return SpecificationGradeToleranceTable(
      specificationNumber:
